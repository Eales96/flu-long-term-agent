...
dat1 <- read.table('input_data/AttackRates/baseline_low.csv', header=F, sep=',')
...
#AR_1A$yr <- AR_1A$TSI
#AR_1B <- AR_1A
#AR_1A$TSI <- AR_1A$TSI-0.99
#AR_1 <- rbind(AR_1A, AR_1B)
...
ggsave('figures/Baseline/Figure3_low.pdf', width=12, height=8.5)
